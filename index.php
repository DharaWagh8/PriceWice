                ...
                <div class="container">
                    <div class="row">
                        <div class="slide-text <?php if ($row['position'] == 'Left') {
                            ...
                            <a href="<?php echo $row['button_url']; ?>" class="btn btn-primary" data-animation="animated <?php if ($row['position'] == 'Left') {
                                                                                                                                                echo 'fadeInLeft';
                                                                                                                                            } elseif ($row['position'] == 'Center') {
                                                                                                                                                echo 'fadeInDown';
                                                                                                                                            } elseif ($row['position'] == 'Right') {
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="product-carousel">
                        ...
                        <div class="text">
                           <h3><a href="product.php?id=<?php echo $row['p_id']; ?>"><?= $sofresult['name'] ?></a></h3>
                        </div>
                            </div>
                        <?php
                        }
